            ...
            <div class="md:flex md:justify-between md:gap-14 space-y-8">
                ...
                <div
                    ...
                    <p class="text-white md:text-6xl sm:text-5xl text-3xl"><span
                            class="text-snapchat-yellow md:text-8xl sm:text-7xl text-5xl font-bold">3
                        </span>Years
                        of Experience</p>
                    <p class="text-white md:text-6xl sm:text-5xl text-3xl"><span
                            class="text-snapchat-yellow md:text-8xl sm:text-7xl text-5xl font-bold">317</span>+
                        Million Plays</p>
                    <img src="{{ asset('assets/Snapchat-Rotated.png') }}"
                        class="absolute md:w-40 w-20 md:right-[6%] sm:right-[6%] right-0 md:top-1/2 top-2/3 -translate-y-1/2"
                        alt="">
                    <button
