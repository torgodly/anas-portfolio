        ...
        <article class="space-y-8 sm:space-y-8 xl:space-y-12">
            ...
            <div class="md:flex md:justify-between md:gap-8 xl:gap-12">
                ...
                <div class="mt-8 space-y-4 md:mt-0 md:w-[35%]">
                    <div
                        class="grid h-16 content-center rounded-3xl bg-white p-4 text-center font-somar text-3xl font-medium text-black sm:h-[68px] sm:text-4xl md:h-20 md:text-5xl">
                        <p>Anas El-Ferjani</p>
                    </div>
                    <div
                        class="text-nowrap grid h-16 content-center rounded-3xl bg-snapchat-yellow p-4 text-center font-somar text-3xl font-medium text-black sm:h-[68px] sm:text-4xl md:h-20 md:text-5xl">
