        ...
        <article class="sm:space-y-14 space-y-8">
            ...
            <div class="sm:flex-row flex flex-col-reverse sm:gap-14 gap-6">
                ...
                <div class="bg-white rounded-3xl sm:w-3/5 sm:p-10 p-4 grid text-black">
                    <p class="sm:text-8xl text-6xl">{{$user?->welcome_message}}</p> <button <button
                ...
                {{-- Profile Picture --}}
                <img src="{{ asset('storage/'. $user?->profile_picture) }}" class="sm:w-2/5 aspect-square size-fit "
                    alt="Profile Picture">
            </div>
            ...
            <div class="sm:flex sm:justify-between sm:gap-14 space-y-8">
                ...
                <div
                    ...
                    <p class="text-white sm:text-6xl text-3xl"><span class="text-snapchat-yellow sm:text-8xl text-5xl font-bold">{{$user?->years_of_experience}}</span>+
                        </span>Years
                        of Experience</p>
                    <p class="text-white sm:text-6xl text-3xl"><span class="text-snapchat-yellow sm:text-8xl text-5xl font-bold">{{$user?->plays}}</span>+
                        Million Plays</p>
                ...
                <div class="space-y-4 sm:w-[35%] ">
                    ...
                    <div class="flex justify-between">
                        <a href="{{$user?->snapchat}}" class="sm:h-24 h-[70px] bg-white rounded-2xl flex content-center p-4 aspect-square"><img
                                src="{{ asset('assets/Snapchat.png') }}" alt=""></a>
                        <a href="{{$user?->twitter}}" class="sm:h-24 h-[70px] bg-white rounded-2xl flex content-center p-4 aspect-square"><img
                                src="{{ asset('assets/Twitter.png') }}" alt=""></a>
                        <a href="{{$user?->instagram}}" class="sm:h-24 h-[70px] bg-white rounded-2xl flex content-center p-4 aspect-square"><img
                                src="{{ asset('assets/Instagram.png') }}" alt=""></a>
                        <a href="{{$user?->discord}}" class="sm:h-24 h-[70px] bg-white rounded-2xl flex content-center p-4 aspect-square"><img
