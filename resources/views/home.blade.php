<x-app-layout>
    <main class="mt-6 mx-10">
        <article class="space-y-14">
            ...
            <div class="flex gap-14">
                ...
                <div class="bg-white rounded-3xl w-3/5 p-10 grid text-black ">
                    <p class="text-8xl">Hi, I'm Anas and this is my work gallery</p> <button <button
                        class="bg-black rounded-3xl px-12 py-4 mt-6 text-3xl font-bold justify-self-start  text-white">See
                        Lenses</button>
                </div>
                {{-- Profile Picture --}}
            ...
            <div class="flex justify-between gap-14">
                {{-- Experience Level --}}
                <div
                    class="bg-white bg-opacity-15 border-4 grid relative border-white rounded-3xl w-[65%] p-6 text-black">
                    ...
                    <img src="{{ asset('assets/Snapchat-Rotated.png') }}"
                        class="absolute w-40 right-6 top-1/2 -translate-y-1/2" alt="">

                    <button
                        class="bg-white rounded-3xl px-12 py-4 mt-6 text-3xl font-bold justify-self-center text-black">See
                        Lenses</button>
                </div>
                {{-- Persoanl Information --}}
                <div class="space-y-4 w-[35%] ">
                    <div class="rounded-3xl bg-white h-20 p-4 grid content-center text-black text-center text-3xl font-bold">
                        <p>Anas El-Ferjani</p>
                    </div>
                    <div class="rounded-3xl bg-snapchat-yellow h-20 p-4 grid content-center text-black text-center text-3xl font-bold">
                    ...
                    <div class="flex justify-between">
                        <a href="#" class="h-24 bg-white rounded-2xl flex content-center p-6 aspect-square"><img
        ...
        {{-- Skills Progress bar --}}
        <section class="my-20 grid grid-cols-3 gap-8 justify-between">

            {{-- Snapchat --}}
            <div class="p-10 rounded-2xl bg-snapchat-yellow bg-opacity-15 w-full relative">
                <img src="{{ asset('assets/Lens.png') }}" class="absolute w-[70px] left-5 top-1/2 -translate-y-1/2 z-10"
                    alt="">
