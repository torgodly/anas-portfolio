...
$classes =
$active ?? false
? 'block w-full ps-3 pe-4 py-2 border-l-4 border-snapchat-yellow text-opacity-90 bg-snapchat-yellow bg-opacity-20
text-start text-base font-medium text-snapchat-yellow bg-primary-50 dark:bg-primary-900/50 focus:outline-none
focus:text-primary-800 dark:focus:text-primary-200 focus:bg-primary-100 dark:focus:bg-primary-900
focus:border-primary-700 dark:focus:border-primary-300 transition duration-150 ease-in-out'
